    ...
    return (
        <div className={styles.pagewrapper}>
            ...
            <div className={styles.herocarouselcontainer}>
                <Carousel autoplay={true} fade={true} speed={900} effect='fade' autoplaySpeed={1500} dots={false} style={{width: "100%",height: "85svh", display:"flex"}}>
                    <Image src={carpenterPicWes} alt="" className={styles.carouselimages}/>
                    <Image src={carpenterPicCar} alt="" className={styles.carouselimages}/>
                    <Image src={carpenterPicWes} alt="" className={styles.carouselimages}/>    
                </Carousel>
